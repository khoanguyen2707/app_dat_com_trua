...
export const t = {
  ...
  menu: {
    ...
    notPostedYet: 'Quán chưa đăng thực đơn hôm nay. Dưới đây là toàn bộ món để bạn tham khảo.',
    onePriceNote: (price: string) => `${price} một suất, chọn bao nhiêu món cũng vậy`,
